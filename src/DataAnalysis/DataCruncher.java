...
public class DataCruncher
{
	...
	{
		products = removeOutliers(products);
	...
	private Product[] removeOutliers(Product[] products)
	{
		double Q1, Q3, IQR;
...
//			q1 and a3 are between odd numbers
		...
		products = Arrays.stream(products).filter(elem -> elem.getVolume() < (Q1 - IQR) && elem.getVolume() > (Q3 + IQR)).toArray(Product[]::new);
